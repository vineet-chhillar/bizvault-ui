...
const shortcuts = getShortcuts(user, hasPermission, PERMISSIONS);

const shortcutMap = Object.fromEntries(
  shortcuts.map(s => [
    s.path,
    `Alt + ${s.shift ? "Shift + " : ""}${s.key.toUpperCase()}`
  ])
);
...
useEffect(() => {
  ...
  const match = shortcuts.find(s => 
    s.key === key &&
    (!!s.shift === e.shiftKey)   // 👈 handles Shift properly
  );
...
<div className="nav-section">
  ...
  >
    ...
    <span className="label">Item {shortcutMap["/Item/CreateItem"] && (
      <span className="shortcut">
        {shortcutMap["/Item/CreateItem"]}
      </span>
    )}</span>
...
<div className="nav-section">
  ...
  >
    <span className="icon"><FaMoneyBillWave /></span>
    <span className="label">Masters</span>
    <span className="arrow">{isMastersOpen ? "▲" : "▼"}</span>
  </div>

  {/* Collapsible Children */}
 <div className={`nav-children-tabs ${isMastersOpen ? "open" : ""}`}>
    <NavLink
      to="/item/HsnMaster"
      onClick={() => isMobile && setMobileOpen(false)}
      className={({ isActive }) =>
...
<div className="nav-section">
  ...
  >
    ...
    <span className="label">Purchase {shortcutMap["/Item/PurchaseInvoiceEditor"] && (
      <span className="shortcut">
        {shortcutMap["/Item/PurchaseInvoiceEditor"]}
      </span>
    )}</span>
...
<div className="nav-section">
  ...
  >
    <span className="icon"><FaMoneyBillWave /></span>
    <span className="label">Sales {shortcutMap["/Item/InvoiceEditor"] && (
      <span className="shortcut">
        {shortcutMap["/Item/InvoiceEditor"]}
      </span>
    )}</span>
...
>
  ...
  <span className="label">
    Accounts
    {shortcutMap["/Item/ChartOfAccounts"] && (
      <span className="shortcut">
        {shortcutMap["/Item/ChartOfAccounts"]}
      </span>
    )}
...
>
  ...
  <span className="label">
    Voucher Editor
    {shortcutMap["/Item/VoucherEditor"] && (
      <span className="shortcut">
        {shortcutMap["/Item/VoucherEditor"]}
      </span>
    )}
...
>
  ...
  <span className="label">
    Incomes
    {shortcutMap["/Item/IncomeVoucherEditor"] && (
      <span className="shortcut">
        {shortcutMap["/Item/IncomeVoucherEditor"]}
      </span>
    )}
...
>
  ...
  <span className="label">
    Expenses
    {shortcutMap["/Item/ExpenseVoucherEditor"] && (
      <span className="shortcut">
        {shortcutMap["/Item/ExpenseVoucherEditor"]}
      </span>
    )}
...
/>
<Route path="/Item/MakeSalesPayment" element={
    <ProtectedRoute allow={hasPermission(user, PERMISSIONS.VOUCHERS)}>
    <MakeSalesPayment user={user} />
    </ProtectedRoute>
    } />

    <Route path="/Item/MakePurchasePayment" element={
    <ProtectedRoute allow={hasPermission(user, PERMISSIONS.VOUCHERS)}>
    <MakePurchasePayment user={user} />
    </ProtectedRoute>
    } />
